...
//For the puprose of this lab all contracts are flatten.
...
contract RoyalityPointsExchange {
	...
	function withdraw() public payable {
        ...
        //Must send ether to get RoyalityToken
        //require (msg.value > 0 ether); 
        
        //Our exchange rate is: 1 miles equals 1 token(s) multiply by the rate (set inside constructor).
